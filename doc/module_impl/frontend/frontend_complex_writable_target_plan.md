...
- 待实施：现有 backend 已修复 backing-field getter/self-setter 的 shallow temp materialization，
  但 `CBodyBuilder` 的 non-object value-semantic self/alias assignment 仍缺少统一的 may-alias-safe write path。
