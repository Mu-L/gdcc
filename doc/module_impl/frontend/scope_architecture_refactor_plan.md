...
- 状态：事实源维护中（`Scope` / frontend scope chain / shared resolver 已落地，signal S0/S1 已落地，frontend binder 与 receiver-based signal resolver 接入待实施）
- 更新时间：2026-03-09
- 适用范围：
...
- 对 gdcc class、engine class、builtin receiver 的 direct / inherited signal 能正确得到 `Resolved` 结果。
