...
public class ScopeCaptureShapeTest {
    ...
    void captureWinsOverClassAndGlobalBindings() {
        ...
        var callable = new CallableScope(classScope, CallableScopeKind.LAMBDA_EXPRESSION);
        ...
        assertEquals(CallableScopeKind.LAMBDA_EXPRESSION, callable.kind());
    ...
    void nestedBlocksResolveCaptureThroughParentChain() {
        ...
        var outerBlock = new BlockScope(callable, BlockScopeKind.BLOCK_STATEMENT);
        var innerBlock = new BlockScope(outerBlock, BlockScopeKind.BLOCK_STATEMENT);

        assertEquals(BlockScopeKind.BLOCK_STATEMENT, outerBlock.kind());
        assertEquals(BlockScopeKind.BLOCK_STATEMENT, innerBlock.kind());
    ...
    void duplicateParameterAndCaptureNamesAreRejected() {
        ...
        var callable = new CallableScope(
